...
Project bootstrap (env setup, key:generate, migrate, npm build, git init) happens via the `composer setup` script — run manually after setting the project name in `.env.example`/`.env`. starting the dev server is a manual step.
